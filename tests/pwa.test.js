...
function serviceWorker(){
 ...
 const context={URL,caches:{open:async()=>cache,keys:async()=>['undertone-v3','undertone-v11','undertone-v13','undertone-v14','undertone-v15','undertone-v16','undertone-v17','undertone-v18','undertone-v19','undertone-v20','undertone-v21','undertone-v22','undertone-v23','undertone-v24','undertone-v25','undertone-v26','undertone-v27','unrelated-cache','undertone-library-v1'],delete:async key=>deleted.push(key)},fetch:async req=>{network.push(req);return 'network';},self:{location:{origin:'https://undertone.test'},skipWaiting:async()=>{},clients:{claim:async()=>{}},addEventListener:(type,fn)=>handlers[type]=fn}};
...
test('activation removes only obsolete Undertone caches',async()=>{
 const sw=serviceWorker();let ready;sw.handlers.activate({waitUntil:p=>ready=p});await ready;assert.deepEqual(sw.deleted,['undertone-v3','undertone-v11','undertone-v13','undertone-v14','undertone-v15','undertone-v16','undertone-v17','undertone-v18','undertone-v19','undertone-v20','undertone-v21','undertone-v22','undertone-v23','undertone-v24','undertone-v25','undertone-v26','undertone-v27']);
});
