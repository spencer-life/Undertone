...
class Param{constructor(value=0){this.value=value;}cancelScheduledValues(){return this;}setValueAtTime(value){this.value=value;return this;}linearRampToValueAtTime(value){this.value=value;return this;}setTargetAtTime(value){this.value=value;return this;}}
